...
nodes = [
    ...
    ("node_31", (797, 772), [], ["node_32", "node_30"]),
    ...
    ("node_27", (1385, 835), ["Seattle", "Portland"], ["node_27", "node_37", "node_24"]),
